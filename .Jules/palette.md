...
## 2025-02-14 - Interactive Button Feedback
**Learning:** Static buttons that perform actions without visual feedback leave users uncertain if their action succeeded.
**Action:** Add temporary "Saved" states with an icon to confirm action completion.

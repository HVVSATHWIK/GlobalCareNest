...
const MoodTracker: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <button
        type="button"
        className="w-full mt-6 px-4 py-2 bg-[#219B9D] text-white rounded-full hover:bg-opacity-90 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#219B9D] focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        disabled={!selectedMood || !selectedTime}
        title="Please select both mood and time to save"
      >
        Save Entry
      </button>
    </div>

    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {selectedMood && selectedTime && (
        <button
          ...
          className={`w-full mt-6 px-4 py-2 flex items-center justify-center text-white rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#219B9D] focus-visible:ring-offset-2 ${
